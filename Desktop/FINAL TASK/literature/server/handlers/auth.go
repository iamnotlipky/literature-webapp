...
func (h *handlerAuth) Register(w http.ResponseWriter, r *http.Request) {
	...
	response := dto.SuccessResult{Message: http.StatusOK, Data: convertResponse(data)}
	json.NewEncoder(w).Encode(response)
}
...
func (h *handlerAuth) Login(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	response := dto.SuccessResult{Message: http.StatusOK, Data: loginResponse}
	json.NewEncoder(w).Encode(response)
...
func (h *handlerAuth) CheckAuth(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	response := dto.SuccessResult{Message: http.StatusOK, Data: CheckAuthResponse}
	json.NewEncoder(w).Encode(response)
}
